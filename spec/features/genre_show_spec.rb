...
describe 'A visitor' do
  describe 'going to a genre show page' do
    it 'will see all the songs associated with that genre' do
      ...
      song_4 = artist.songs.create(title: "Helo", length: 2543, play_count: 9865452)
      ...
      SongGenre.create(song: song_4, genre: g_2)
    ...
    it 'will see the name and rating of the song with the highest rating of all songs in the genre' do
      artist = Artist.create(name:'Adele')
      song_1 = artist.songs.create(title: "Don't Stop Believin", length: 303, play_count: 123456, rating: 3)
      song_2 = artist.songs.create(title: "Never Gonna Give You Up", length: 253, play_count: 98762452, rating: 1)
      song_3 = artist.songs.create(title: "Hey ya", length: 2543, play_count: 9865452, rating: 5)
    ...
    it 'will see the name and rating of the song with the lowest rating of all songs in the genre' do
      artist = Artist.create(name:'Adele')
      song_1 = artist.songs.create(title: "Don't Stop Believin", length: 303, play_count: 123456, rating: 3)
      song_2 = artist.songs.create(title: "Never Gonna Give You Up", length: 253, play_count: 98762452, rating: 1)
      song_3 = artist.songs.create(title: "Hey ya", length: 2543, play_count: 9865452, rating: 5)
      ...
      expect(page).to have_content("Song With Lowest Rating: #{g_1.lowest_rated_song.title} wiht rating of #{g_1.lowest_rated_song.rating}/5")
    end
  end
end
